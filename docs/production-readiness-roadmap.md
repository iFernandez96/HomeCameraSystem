...
offline notification while every Jetson process is unavailable, restore power,
and observe recovery. It was not run because this session has no remote way to
restore Jetson power; PR-206 must not be marked `Done` until that evidence is
recorded. Physical mount identity and fallback-write prevention remain PR-207;

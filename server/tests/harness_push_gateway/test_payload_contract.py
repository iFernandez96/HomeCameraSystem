...
async def test_given_canonical_event_with_thumb_when_push_payload_built_then_send_matching_receives_contract_payload(
    client,
    monkeypatch,
):
    # given
    ...
    assert payload["image"] == "/snapshots/thumb_1700000000000.jpg"

    ...
    return restore_api_response_from_orchestrator(
        RestoreOrchestratorRequest(
            ...
            restore_roots={
                ...
                "events_db": settings.events_db_path.parent,
                "audit_db": settings.audit_db_path.parent,
                ...
                "clip_shares": settings.clip_shares_path.parent,
                "digest_state": settings.digest_state_path.parent,
                "camera_exposure": settings.camera_exposure_path.parent,
                "camera_exposure_presets": settings.camera_exposure_path.parent,
